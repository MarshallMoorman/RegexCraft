...
| [Library and History](library-and-history.md) | Built-in + user patterns, favorites, history |
| [Theme & appearance](theme-and-appearance.md) | Light/dark themes (persisted), editor contrast |
