...
public sealed class CodeGenerationService : ICodeGenerationService
{
        ...
        string engineId)
    {
        ...
        var body = language switch
        {
            ...
            CodeLanguage.JavaScript => GenerateJavaScript(operation, pattern, subject, replacement, options, engineId),
    ...
    {
        var engine = string.Equals(engineId, "pcre2", StringComparison.OrdinalIgnoreCase) ? "PCRE2" : ".NET";
